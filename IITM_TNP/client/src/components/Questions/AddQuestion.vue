...
<template>
    <MDBBtn color="primary" aria-controls="addQuestionModalTitle" @click="addQuestionModal = true">
        Add Question
    </MDBBtn>
    <MDBModal id="exampleModalScrollable" tabindex="-1" labelledby="addQuestionModalTitle" v-model="addQuestionModal"
        scrollable>
        <MDBModalHeader>
            <MDBModalTitle id="addQuestionModalTitle"> Add Question </MDBModalTitle>
        </MDBModalHeader>
        <MDBModalBody>
            <form>
        ...
        <MDBModalFooter>
            <MDBBtn color="secondary" @click="addQuestionModal = false"> Close </MDBBtn>
            <MDBBtn color="primary" @click="submitQuestion"> Save changes </MDBBtn>
        </MDBModalFooter>
    </MDBModal>
</template>