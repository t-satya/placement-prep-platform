...
import { STUDENT_REGISTER_URL_BACKEND } from "../../utils/constants.js";
...
function register() {
    ...
    axios.post(STUDENT_REGISTER_URL_BACKEND, data, options).then((res) => {
        router.push("/login?msg=Successfully Registered");
    }).catch((err) => {
